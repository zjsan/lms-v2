                            ...
                            <div class="block-content collapse in">
								...
								?>
										...
										<div class="control-group">
											...
											<input type="text" class="span8" name="quiz_title" value="<?php echo $row['quiz_title']; ?>" id="inputEmail" placeholder="Quiz Title">
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassingGrade">Passing Grade (%)</label>
											<div class="controls">
											<input type="number" step="0.01" value="<?php echo $row['passing_grade_pct']; ?>" class="" name="passing_grade_pct" id="inputPassingGrade" placeholder="Passing Grade" required>
											</div>
										</div>	
										...
										$passing_grade_pct = $_POST['passing_grade_pct'];
										mysqli_query($conn,"update quiz set quiz_title = '$quiz_title',quiz_description = '$description', passing_grade_pct='$passing_grade_pct' where quiz_id = '$quiz_id'")or die(mysqli_error());
										?>
										<script>
