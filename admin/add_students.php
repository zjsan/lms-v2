                            ...
                            <div class="block-content collapse in">
								...
								<form id="add_student" method="post">
										...
										<div class="control-group">
										  ...
										  <div class="error-container hide" style="margin-top: -8px;">
										  	<span style="color: #b94a48;">Test</span>
										  </div>
                                        </div>
					...
					$.ajax({
						...
						success: function(html){
							if(html=='true')
							{
								...
								$.jGrowl("Student Username already exist!", { header: 'Sign Up Failed' });
								$("div.error-container").removeClass("hide");
								$("div.error-container span").html("Student Id already exist!");
							}
						}
					});
				});
