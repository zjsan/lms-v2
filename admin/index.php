  ...
  <body id="login">
    <div class="container">
      ...
      <form id="login_form" class="form-signin" method="post">
		...
		<button class="btn btn-success pull-right" onclick="location.href='../'" type="button"><i class="icon-home"></i> Home </button>
	</form>
				<script>
			...
			jQuery("#login_form").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to TCSF Learning Management System", { header: 'Access Granted' });
						var delay = 2000;
