			...
			<div id="button_form" class="form-signin" >
				...
				<button data-placement="top" title="Sign Up as Student" id="signup_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit">I`m a Student</button>
